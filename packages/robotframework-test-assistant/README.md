...
This is a working proof-of-concept "leon-ai package" (similar to Alexa Skills) that focuses on RPA, assisting testers, non-testers, technical people, and non-technical people who work on the same product/software development team. Feel free to fork this and use it as a template to build your own test/RPA assistant. 
